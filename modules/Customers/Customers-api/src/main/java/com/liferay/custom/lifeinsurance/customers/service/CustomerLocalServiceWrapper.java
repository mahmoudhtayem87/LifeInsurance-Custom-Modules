...
public class CustomerLocalServiceWrapper
	 ...
	 */
	@Override
	public com.liferay.custom.lifeinsurance.customers.model.Customer
		addCustomer(
			com.liferay.custom.lifeinsurance.customers.model.Customer
				customer) {
	...
	public com.liferay.custom.lifeinsurance.customers.model.Customer
			addCustomer(
				...
				String email, String phoneNumber, String DOB, String roleId,
				String createdBy, String GroupId,
	...
	@Override
	public com.liferay.custom.lifeinsurance.customers.model.Customer
		createCustomer(long customerId) {
