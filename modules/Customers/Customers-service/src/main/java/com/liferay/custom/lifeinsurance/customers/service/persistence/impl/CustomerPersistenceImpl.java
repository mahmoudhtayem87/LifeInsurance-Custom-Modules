...
package com.liferay.custom.lifeinsurance.customers.service.persistence.impl;

import com.liferay.custom.lifeinsurance.customers.exception.NoSuchCustomerException;
import com.liferay.custom.lifeinsurance.customers.model.Customer;
import com.liferay.custom.lifeinsurance.customers.model.CustomerTable;
import com.liferay.custom.lifeinsurance.customers.model.impl.CustomerImpl;
import com.liferay.custom.lifeinsurance.customers.model.impl.CustomerModelImpl;
import com.liferay.custom.lifeinsurance.customers.service.persistence.CustomerPersistence;
import com.liferay.custom.lifeinsurance.customers.service.persistence.CustomerUtil;
import com.liferay.custom.lifeinsurance.customers.service.persistence.impl.constants.CUSTOMERSPersistenceConstants;
...
public class CustomerPersistenceImpl
	...
	/**
	 * Returns all the customers where customerId = &#63;.
	 *
	...
	/**
	 * Returns a range of all the customers where customerId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>CustomerModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the customers where customerId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>CustomerModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the first customer in the ordered set where customerId = &#63;.
	 *
	 * @param customerId the customer ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching customer
	...
	public Customer findByCustomerId_First(
			long customerId, OrderByComparator<Customer> orderByComparator)
		throws NoSuchCustomerException {

		Customer customer = fetchByCustomerId_First(
	...
	/**
	 * Returns the last customer in the ordered set where customerId = &#63;.
	 *
	 * @param customerId the customer ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching customer
	...
	public Customer findByCustomerId_Last(
		...
		Customer customer = fetchByCustomerId_Last(
			customerId, orderByComparator);
	...
	/**
	 * Removes all the customers where customerId = &#63; from the database.
	 *
	 * @param customerId the customer ID
	 */
	@Override
	...
	/**
	 * Returns the number of customers where customerId = &#63;.
	 *
	 * @param customerId the customer ID
	 * @return the number of matching customers
	 */
	...
	@Override
	@Reference(
		target = CUSTOMERSPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = CUSTOMERSPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
