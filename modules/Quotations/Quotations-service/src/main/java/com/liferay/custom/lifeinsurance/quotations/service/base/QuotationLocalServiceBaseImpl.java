...
import com.liferay.custom.lifeinsurance.quotations.service.QuotationLocalServiceUtil;
...
/**
 * Provides the base implementation for the quotation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.custom.lifeinsurance.quotations.service.impl.QuotationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.custom.lifeinsurance.quotations.service.impl.QuotationLocalServiceImpl
 * @generated
 */
public abstract class QuotationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, QuotationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuotationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>QuotationLocalServiceUtil</code>.
	 */
	...
	public Quotation addQuotation(Quotation quotation) {
		...
		return quotationPersistence.update(quotation);
	}
	...
	public Quotation createQuotation(long quotationId) {
		return quotationPersistence.create(quotationId);
	}
	...
	public Quotation deleteQuotation(long quotationId) throws PortalException {
		return quotationPersistence.remove(quotationId);
	}
	...
	public Quotation deleteQuotation(Quotation quotation) {
		return quotationPersistence.remove(quotation);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return quotationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Quotation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return quotationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return quotationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quotationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return quotationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Quotation fetchQuotation(long quotationId) {
		return quotationPersistence.fetchByPrimaryKey(quotationId);
	}
	...
	public Quotation fetchQuotationByUuidAndGroupId(String uuid, long groupId) {
		return quotationPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Quotation getQuotation(long quotationId) throws PortalException {
		return quotationPersistence.findByPrimaryKey(quotationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(quotationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Quotation.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			quotationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Quotation.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Quotation>() {

				@Override
				public void performAction(Quotation quotation)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, quotation);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return quotationPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quotationLocalService.deleteQuotation((Quotation)persistedModel);
	}

	@Override
	public BasePersistence<Quotation> getBasePersistence() {
		return quotationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quotationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Quotation> getQuotationsByUuidAndCompanyId(
		...
		return quotationPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Quotation> getQuotationsByUuidAndCompanyId(
		...
		return quotationPersistence.findByUuid_C(
	...
	public Quotation getQuotationByUuidAndGroupId(String uuid, long groupId)
		...
		return quotationPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Quotation> getQuotations(int start, int end) {
		return quotationPersistence.findAll(start, end);
	}
	...
	public int getQuotationsCount() {
		return quotationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuotationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		quotationLocalService = (QuotationLocalService)aopProxy;

		_setLocalServiceUtilService(quotationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuotationLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = QuotationLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, quotationLocalService);
		}
	...
	protected QuotationLocalService quotationLocalService;
