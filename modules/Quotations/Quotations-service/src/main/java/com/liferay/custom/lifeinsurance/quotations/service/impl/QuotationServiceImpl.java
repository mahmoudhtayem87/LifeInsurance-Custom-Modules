...
import com.liferay.custom.lifeinsurance.quotations.service.base.QuotationServiceBaseImpl;
...
@Component(
	property = {
		"json.web.service.context.name=quotation",
		"json.web.service.context.path=Quotation"
	},
...
public class QuotationServiceImpl extends QuotationServiceBaseImpl {
	public Quotation addQuotation(String createdBy,String groupId,String quotationType, String quotationData,String quotationAmount,String customerId) throws PortalException {
		return quotationLocalService.addQuotation(createdBy,  groupId,  quotationType,  quotationData,  quotationAmount,  customerId);
	}
	public List<Quotation> getAllQuotations()
	{
		return quotationLocalService.getAllQuotations();
	}
	...
	{
		quotationLocalService.deleteAllQuotations();
	}
}